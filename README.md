...
Most of the pipeline is taking existing tools/scripts and finding a way to make the outputs and inputs compatible. I wrote all of the bash scripts (.sh or .job). The rest were obtained from the courses that I had taken previously or were found in relation to aTRAM. Below is the pipeline.
